...
export const HOLDINGS: Holding[] = [
  ...
  { ticker: "ANRO", company: "Alto Neuroscience", weight: 5.23, price: 6.42, dayPct: 8.1, spark: [0.00, 0.03, 0.20, 0.56, 0.79, 1.00, 0.90, 0.88], shortInterestPct: 14.8, nextCatalyst: { label: "ALTO-100 MDD biomarker readout", days: 110 }, category: "Pure-Play" },
  { ticker: "NRXP", company: "NRx Pharmaceuticals", weight: 5.04, price: 1.45, dayPct: 16.8, spark: [1.00, 0.00, 0.72, 0.20, 0.68, 0.78, 0.55, 0.48], shortInterestPct: 22.1, nextCatalyst: { label: "NRX-100 NDA progress", days: 60 }, category: "Adjacent" },
  ...
  { ticker: "ABBV", company: "AbbVie", weight: 4.44, price: 198.40, dayPct: 1.2, spark: [0.70, 0.26, 0.00, 0.18, 1.00, 0.64, 0.55, 0.74], shortInterestPct: 1.4, nextCatalyst: { label: "Q1 2026 earnings", days: 8 }, category: "Big Pharma" },
  { ticker: "JNJ", company: "Johnson & Johnson", weight: 4.25, price: 165.80, dayPct: 0.8, spark: [0.48, 0.00, 0.19, 0.27, 0.94, 0.63, 0.64, 1.00], shortInterestPct: 0.9, nextCatalyst: { label: "Q1 2026 earnings", days: 2 }, category: "Big Pharma" },
  ...
  { ticker: "NBIX", company: "Neurocrine Biosciences", weight: 4.20, price: 142.50, dayPct: 2.1, spark: [1.00, 0.61, 0.47, 0.01, 0.00, 0.14, 0.06, 0.18], shortInterestPct: 3.1, nextCatalyst: { label: "Q1 earnings", days: 18 }, category: "Adjacent" },
  ...
  { ticker: "SUPN", company: "Supernus Pharmaceuticals", weight: 3.91, price: 35.20, dayPct: 1.8, spark: [0.54, 0.20, 0.86, 1.00, 0.47, 0.10, 0.10, 0.00], shortInterestPct: 4.8, nextCatalyst: { label: "Q1 earnings", days: 16 }, category: "Adjacent" },
  { ticker: "NEUP", company: "Neuphoria Therapeutics", weight: 3.34, price: 4.65, dayPct: 11.2, spark: [0.00, 0.89, 0.67, 0.85, 1.00, 0.48, 0.44, 0.56], shortInterestPct: 9.8, nextCatalyst: { label: "BNC210 anxiety readout", days: 65 }, category: "Pure-Play" },
  ...
  { ticker: "CMND", company: "Clearmind Medicine", weight: 0.03, price: 0.52, dayPct: 5.4, spark: [0.00, 0.24, 0.06, 0.76, 0.39, 0.61, 1.00, 0.67], shortInterestPct: null, nextCatalyst: { label: "CMND-100 Ph1/2a update", days: 110 }, category: "Pure-Play" },
];
