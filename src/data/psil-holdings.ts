...
export const HOLDINGS: Holding[] = [
  ...
  { ticker: "ALKS", company: "Alkermes", weight: 4.24, price: 32.15, dayPct: 3.4, spark: [0.76, 0.96, 1.00, 0.00, 0.05, 0.02, 0.22, 0.13], shortInterestPct: 4.2, nextCatalyst: { label: "Q1 earnings + ALKS 2680 readout", days: 22 }, category: "Adjacent" },
  ...
  { ticker: "NEUP", company: "Neuphoria Therapeutics", weight: 3.34, price: 4.65, dayPct: 11.2, spark: [0.22, 0.00, 0.39, 0.81, 0.70, 0.79, 0.76, 1.00], shortInterestPct: 9.8, nextCatalyst: { label: "BNC210 anxiety readout", days: 65 }, category: "Pure-Play" },
