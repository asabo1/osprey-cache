...
export const HOLDINGS: Holding[] = [
  ...
  { ticker: "NEUP", company: "Neuphoria Therapeutics", weight: 3.34, price: 4.65, dayPct: 11.2, spark: [0.22, 0.00, 0.40, 0.82, 0.72, 0.81, 0.77, 1.00], shortInterestPct: 9.8, nextCatalyst: { label: "BNC210 anxiety readout", days: 65 }, category: "Pure-Play" },
